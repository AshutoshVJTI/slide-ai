        ...
        >
            <div className="p-8 space-y-6 flex-shrink-0">
                <div className="space-y-2">
                    <h2
                        className="text-3xl font-bold tracking-tight" style={{ color: selectedTheme.accentColor }}>
                        Pick a theme
                    </h2>
                    <p
                        className='text-sm'
                        ...
                        >
                            <Button
                                ...
                                <div className="w-full flex items-center justify-between">
                                    <span className="text-x1 font-bold">{theme.name}</span>
                                    <div
